        ...
        >
            <template v-slot:activator="{ on, attrs }">
                <v-btn elevation="0" v-bind="attrs"
                       v-on="on" dark style="background: #2F80ED" class="primary btns rounded-lg">
                    Boshlash
                </v-btn>
            </template>
                ...
                <v-tabs-items v-model="tab" class="grey lighten-5">
                    ...
                    >
                        <v-list-item class="mt-2">
                            ...
                            <v-spacer></v-spacer>
                            <v-btn elevation="0" @click="dialogRight=false"><img src="@/assets/x.svg" alt=""></v-btn>
                        </v-list-item>
                    </v-tab-item>
                </v-tabs-items>
                <br>
                    ...
                    <v-row wrap>
                        <v-col>
                            <v-list
                                ...
                                dense
                                class="mt-1"
                                v-for="item of usersData" :key="item.title"
                            >
                                <v-list-item-group
                                    color="primary"
                                >
                        ...
                        <v-col>
                            ...
                            >
                                ...
                                >
                                    <v-list-item-title class="text--secondary mt-2 linksFont"
                                                       v-text="item.description"></v-list-item-title>
                                </v-list-item-group>
                                <v-text-field
                                    v-if="access"
                            ...
                            <v-btn class="btns rounded-lg primary" elevation="0" style="background: #2F80ED" large dark >Tasdiqlash</v-btn>
                        </v-container>
                    </v-tab-item>
                </v-tabs-items>
                <v-tabs-items v-model="tab" class="grey lighten-5">
                                ...
                                <v-row wrap>
                                    <v-col>
                                        <v-list
                                            nav
                                            dense
                                            class="mt-1 grey lighten-5"
                                            v-for="item of usersData" :key="item.title"
                                        >
                                            <v-list-item-group
                                                color="primary"
                                                class="grey lighten-5 grey lighten-5"
                                            >

                                                <v-list-item-title class="black--text mt-2 linksFont grey lighten-5" v-text="item.title"></v-list-item-title>
                                            </v-list-item-group>
                                        </v-list>
                                    </v-col>
                                    <v-col>
                                        ...
                                        >
                                            <v-list-item-group
                                                ...
                                                class="grey lighten-5"
                                            >
                                                <v-list-item-title class="text--secondary  linksFont grey lighten-5"
                                                                   v-text="item.description"></v-list-item-title>
                                            </v-list-item-group>
                                            <v-text-field
                                                v-if="access"
...
export default {
    data() {
        return {
            ...
            dialog: false,
            items: [
                {tab: 'Ma’lumotlarni to’ldirish', content: 'Tab 1 Content', href: '#documents'},
                {tab: 'Mavjud ma’lumotlar', content: 'Tab 2 Content', chip: true, href: '#withoutdocuments'},
            ],
            selectedItem: [],
            dialogRight: false,
        }
